...
class GenNNSkeToImage(nn.Module):
    ...
    """
    def __init__(self):#TO DO implementing the generator
    ...
    def train(self, n_epochs=20):
        ...
        for epoch in range(n_epochs):
            ...
            for i, (ske, img) in enumerate(self.dataloader):
                ...
                if i % 100 == 0:
                    print(f"Epoch [{epoch}/{n_epochs}] Batch [{i}/{len(self.dataloader)}] Loss: {loss.item()}")
